...
========================
In Blender's Scripting workspace, open this file and click Run Script.

What it does:
  1. Exports all node types to ~/Documents/cortex-bridge/blender_nodes.json
...
EXPORT_FILE  = os.path.join(os.path.expanduser("~"), "Documents", "cortex-bridge", "blender_nodes.json")
        ...
        try:
            ...
            while _running:
                ...
                if t == "REQUEST_NODES":
                    ...
                    print(f"[CORTEX] Sent {len(nodes)} nodes — check the CORTEX library!")
